...
static vec2 perp(vec2 in) {
  return {-in.y, in.x};
}

static void init_vao(uint* vao, uint* vbo, const std::vector<int>& attribs) {
...
static void init_program(uint* prog, const std::string& vs, const std::string& fs, const std::string& gs = "") {
